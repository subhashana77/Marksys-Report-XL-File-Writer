...
//            if (rs.next()) {
            if (false) {
                ...
                if (!emailList.equals("nodata")) {
                    sendEmail(emailList, "salesorder.exp@arpico.com", "Expired Sales Orders: ", m_msgbody, m_msgbody2, "");
                }
            }
...
//                throw new Exception("Please Set the Email Informations.");
    ...
    public void poexpire() throws Exception {
        /////////////////////////////////////////////////////////////////////////
        ////////// po expire @me
        ///////////////////////////////////
...
//                            sendEmailPurchaseOrders("sudeepf@arpico.com,pabodhar@arpico.com", "salesorder.exp@arpico.com", "Expired Purchase Orders - Richard Pieris & Company ", m_msgpobody, m_msgpobody2, "<br><br><br> This is an automated message from Purchase order expiry process.");
                    if (distributerEmail != null) {
//                            sendEmailPurchaseOrders(distributerEmail, "salesorder.exp@arpico.com", "Expired Purchase Orders - Richard Pieris & Company ", m_msgpobody, m_msgpobody2, "<br><br><br> This is an automated message from Purchase order expiry process.");
                    }
...
//                                + "sudeepf@arpico.com,pabodhar@arpico.com", "salesorder.exp@arpico.com", "Expired Purchase Orders (ASM) - Richard Pieris & Company ", "<strong>List of Expired Purchase Orders Of "
...
//                        sendEmailPurchaseOrders(""
//                                + "" + distributerHeadEmail ,"salesorder.exp@arpico.com", "Expired Purchase Orders (ASM) - Richard Pieris & Company ", "<strong>List of Expired Purchase Orders Of "
//                                + "" + hashHData.getKey().toString().split("_")[1].split("-")[0] + " "
//                                + "" + hashHData.getKey().toString().split("_")[0] + " "
//                                + "" + hashHData.getKey().toString().split("_")[1].split("-")[1]
//                                + "</strong>", m_msgbodyHead, "<br><br><br> This is an automated message from Purchase order expiry process.");
...
//                    sendEmailPurchaseOrders(getEmailAddressPurchaseOrders(), "salesorder.exp@arpico.com", "Blank Email Address List for Expired Purchase Orders :- ", "Customer Details ", ListBody, "<br><br><br> This is an automated message from Purchase order expiry process Email ERR Customer List .");
            }
    ...
    public void pendingPR() {
        ...
        String sql = "SELECT distinct COMCOD com_sbu,(REQSNO)Pr_no,to_char(a.REQDAT,'DD/MM/YYYY') pr_date,b.sbu_name,nxtapp FROM purchasereqs a\n"
                ...
                + "where nxtapp in ('1200','323')  and status<20\n"
        ...
        try {
            ...
            for (Map.Entry hashHData : treeMap.entrySet()) {
                hashHData.getKey();
                if (hashHData.getKey().toString().split("@@")[1].equals("1200")) {
                ...
                } else if (hashHData.getKey().toString().split("@@")[1].equals("323")) {
                    HashMap<String, HashMap<String, String>> hm = (HashMap<String, HashMap<String, String>>) hashHData.getValue();
                    m_msgbody1 += " <tr>"
                            + "    <td align=\"left\" colspan=\"2\"><span style=\"font-weight: bold;font-size: 14px;\">" + hashHData.getKey().toString().split("__")[0] + "\t:- " + hashHData.getKey().toString().split("__")[1].split("@@")[0] + "</span></td>"
                            + " </tr> ";
            ...
            sendEmailPendingPRApproval(getEmailAddressPendingPRApproval(), "salesorder.exp@arpico.com", "Pending PR Approval of GCFO", "Please see below for pending PR list.", m_msgbody1, "This is System Generated email.For any queries please contact the sender of this mail.<br><br>Regards,<br><br>");
//             sendEmailPendingPRApproval("trevin@arpico.com,sudeepf@arpico.com,menaka.p@arpico.com", "salesorder.exp@arpico.com", "Pending & Approval of GCFO", "Please see below for pending PR list.", m_msgbody1+""+m_msgbody2, "This is System Generated email.For any queries please contact the sender of this mail.<br><br>Regards,<br><br>");
