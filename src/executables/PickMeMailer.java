 ...
 */
public class PickMeMailer {

    OracleConnector conMarksys = null;
    Exception _exception = null;
    Statement stmnt, stmnt2 = null;
    ResultSet rs = null;
    String excelSavePath = ".//pickmeexcel";

    public void dayEndMail(String date) {

        try {

//            conMarksys = new OracleConnector("192.168.1.27", "RPD2", "TMARKSYS", "TMARKSYS");
...
//            String repPath = "ftp://192.168.1.28/Report_RPD/Stocks/pickme_itm.jasper";
            if (rs.next()) {
                ...
                if (repObj.get("code").equals("200")) {
                    ...
                    String updateSql = "UPDATE rmis.smautomail SET ATTACH='" + repObj.get("path") + "' WHERE SBUCOD='830' AND LOCCOD='100' AND progid='PickMeMailer'";
    ...
    public JSONObject exportToXLS(String m_strRepPath) {
        ...
        try {
            ...
            String xlsFilePath = excelSavePath + "//PickMe_Report_" + date + ".xls";
